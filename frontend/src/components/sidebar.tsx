  ...
  return (
    <>
      ...
      >
        ...
        <div className="pointer-events-none absolute -top-24 -left-20 w-64 h-64 rounded-full hidden dark:block dark:bg-blue-500/15 blur-3xl" />
        <div className="pointer-events-none absolute top-1/2 -right-28 w-56 h-56 rounded-full hidden dark:block dark:bg-blue-500/15 blur-3xl" />
